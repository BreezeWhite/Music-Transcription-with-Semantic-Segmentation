...
feature_path = "/data/MusicNet/test_feature/harmonic"
#feature_path = "/host/home/AMT_Project/Maestro-val_feature/harmonic"
model_path = "../model-paper/feature-compare_harmonic-musicnet"
pred_save_path = "../prediction-paper/val_feature-compare_harmonic-musicnet"
